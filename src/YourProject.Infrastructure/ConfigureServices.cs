...
using YourProject.Infrastructure.Files;
using YourProject.Infrastructure.Identity;
using YourProject.Infrastructure.Persistence;
using YourProject.Infrastructure.Persistence.Interceptors;
using YourProject.Infrastructure.Services;
...
public static class ConfigureServices
{
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        {
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(File.ReadAllText(".db_connection"), 
